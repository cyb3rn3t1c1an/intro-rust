...
mod literals {
    ...
    #[test]
    fn float_literal() {
        let answer: f64 = std::f64::consts::PI;

        assert_eq!(answer, std::f64::consts::PI);
    }
...
mod expressions {
    ...
    fn closure_expression() {
        let answer: fn(i32) -> i32 = |x: i32| x + 1;
...
mod items {
    ...
    fn struct_item() {
        ...
        let person: Person = Person { name: "Alice", age: 42 };
